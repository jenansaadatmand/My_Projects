...
# get() returns a value for the given key, if the key is not found will return None
...
# in , check if item is in the dictionary
diccc = {1: 'one', 2: 'two' }
...
dic1 = {1: 'one', 2: 'two'}
print(dic1.items()) # Returns Tuples of the list with dictionary pairs
