...
wash_car(12) # Define the positional argument (values to the defined parameter), and keep changing the positional argument to change the output behavior of the function  
