...
wash_car(12) # define the postiional argument (values to the defined parameter), keep changing the positional argument to change the output behavior of the function  
