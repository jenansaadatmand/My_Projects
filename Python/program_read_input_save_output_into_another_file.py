...
# The code in the first couple of lines uses the open method, which opens files with specific names that are located in the same folder as the program file
