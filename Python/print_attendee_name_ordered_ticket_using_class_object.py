...
# The first, def --init-- constructor function to specify what haooens when you use the class in your code. When you use the class, you specify the name and the tickets parameters, which are saved in the new object
